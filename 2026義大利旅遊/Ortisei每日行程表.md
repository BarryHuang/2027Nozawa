...
* **`約 13:45` 🧺 出門前啟動洗衣機**
  * 回飯店放下購物袋後，把要洗的第一批衣物塞進房內洗衣機按下去再出門。接下來 Mar Dolomit / SPA 的 2–3 小時讓機器代勞，回來直接換烘衣機。
...
* **`約 16:00 – 17:00` 🧺 第二批洗衣 ＋ 整理收行李**
  * 回到 Ciastel 後趁晚餐前啟動洗衣機洗剩下的第二批衣物，同時開始整理行李。7/25 早上 07:30 出發，今晚盡量把行李收齊，衣服烘好後直接入箱。
